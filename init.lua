...
require('lazy').setup({
  ...
  { -- Treesitter (Aligned with Upstream Modern API)
    ...
    branch = 'main',
    config = function()
      local parsers = { 'bash', 'c', 'cpp', 'python', 'javascript', 'typescript', 'json', 'lua', 'html', 'java', 'kotlin', 'vim', 'vimdoc', 'latex', 'markdown', 'markdown_inline', 'query' }
      ...
      vim.api.nvim_create_autocmd('FileType', {
        callback = function(args)
          ...
          -- Protected call to avoid crashing on broken system parsers
          pcall(function()
